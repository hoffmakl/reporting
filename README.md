...
Using the raw hours spent on a contract or project (I track these using toggl), calculate the exact percent of time you've spent on that contract in a specified time interval.
